...
<?php
		@$coninb=$_GET['value'];
			...
			$sql="SELECT * FROM draft where draft_id='$coninb'";
...
<table width="100%" class="table">
  ...
  <tr>
    ...
    <td width="277">
	<input type="text" class="form-control" value="<?php echo $row->user_id ?>" name="to" />	</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" class="form-control" value="<?php echo $row->sub ?>" name="sub" /></td>
  </tr>
  <tr>
    <th height="36" scope="row">Upload your file</th>
    <td><input type="file" name="file" id="file"/> <br><span><?php echo $row->attach ?></span> </td>

  </tr>
  <tr>
    <th height="52" scope="row">Message</th>
    <td><textarea rows="8" class="form-control" cols="40" name="msg"><?php echo $row->msg ?></textarea></td>
  </tr>
  <tr>
